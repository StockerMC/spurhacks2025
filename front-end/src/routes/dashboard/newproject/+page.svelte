                        ...
                        <Card>
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" id="project-name" bind:value={projectName} placeholder="e.g., My E-commerce Website Testing" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/80" />
                                </div>
                                <div>
                                    <label for="website-url" class="block text-sm font-medium text-gray-700 mb-2">Website URL</label>
                                    <input type="url" id="website-url" bind:value={websiteUrl} placeholder="https://your-website.com" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/80" />
                                </div>
                            </div>
                        ...
                        <Card>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea bind:value={additionalNotes} id="additional-notes" placeholder="Any additional context, requirements, or special instructions for the testing agents..." class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/80 h-24"></textarea>
                                </div>
                                <div class="bg-green-50 rounded-xl p-6">
                                    <h4 class="font-semibold text-green-900 mb-2">Estimated Timeline</h4>
                                    <p class="text-green-800 text-sm">Based on your selections, testing should complete in approximately <strong>2-4 hours</strong>. You'll receive real-time updates as our agents work through your website.</p>
                                </div>
                            </div>
                            <div class="flex justify-between mt-8">
                                <Button variant="outline" onclick={prevStep}>← Back</Button>
