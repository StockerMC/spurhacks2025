...
>
    ...
    <div class="p-4 border-b border-white/30">
      <div class="flex items-center justify-between">
        {#if !sidebarCollapsed}
          ...
          <div class="cursor-pointer flex items-center space-x-3" onclick={() => goto('/dashboard')}>
            <div
  ...
  <main class="flex-1 overflow-auto relative z-10">
    ...
    >
      <div class="flex items-center justify-between">
        <div>
          <a href={projectData.url} target="_blank" class="text-2xl font-bold text-gray-900">
            {projectData.name}
          </a>
